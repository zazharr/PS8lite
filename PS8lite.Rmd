...
## Fitting Random Forest model directly
# tried different values for mtry and ntree
# the values I chose gave me a better error estimate than the one in sample code
